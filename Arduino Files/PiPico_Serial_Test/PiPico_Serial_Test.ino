...
void loop() {
  ...
  String dataPacket = "";
  dataPacket += String(speed, 2); // Print with 2 decimal places
  dataPacket += ";";
  dataPacket += String(steering_angle, 2);
  dataPacket += ";";
  dataPacket += String(front_brake, 2);
  dataPacket += ";";
  dataPacket += String(back_brake, 2);
  dataPacket += ";";
  dataPacket += String(resistance, 2);
  dataPacket += ";";
